...
public class TableGenerator {
	...
	public bool GetTriangleList(int caseId, int rot, int negFlagIndex, int[] triangles) {
		...
		for (int i = 0; i < caseFlags.GetLength(1); i++) {
			if (caseFlags[caseId, i] == negFlagIndex) {
				for (int j = 0; j < caseTriangles.GetLength(2); j++) {
					int p = caseTriangles[caseId, i, j];
					if (p < 12) {
	...
	public int[,] caseFlags = {
		{0b00010000, 0b01000000, 0b00001000, 0b01010000, 0b00011000, 0b01001000, 0b01011000 },
		{-1, -1, -1, -1, -1, -1, -1}
	};

	public int[,,] caseTriangles = {
		{
			{22+12, 13+12, 6, 13+12, 11, 6, 11, 13+12, 12+12, -1, -1, -1}, 
			{16+12, 13+12, 11, 13+12, 7, 11, 7, 13+12, 22+12, -1, -1, -1}, 
			{13+12, 6, 7, 13+12, 7, 12+12, 13+12, 16+12, 6, -1, -1, -1}, 
			{11, 13+12, 12+12, 11, 16+12, 13+12, -1, -1, -1, -1, -1, -1}, 
			{22+12, 13+12, 6, 13+12, 16+12, 6, -1, -1, -1, -1, -1, -1}, 
			{12+12, 13+12, 7, 13+12, 22+12, 7, -1, -1, -1, -1, -1, -1},  
