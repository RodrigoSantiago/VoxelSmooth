...
public class RoundingGenerator : MeshGenerator {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                if (!IsSubBlockMarked(x + off.x, y + off.y, z + off.z, dax - off)) {
                    if (near[ax + off] && near[nax + off]) {
                        ...
                        EmitVertexRamp(x, y, z, off, ax, nax);
                        
                    } else if (near[nax + off]) {
                        EmitVertexRamp(x, y, z, off, nax, ax);
    ...
    private void EmitVertexFloor(int x, int y, int z, Off3D off, Off3D ax, Off3D nax) {
        ...
        AddTriangle(x, y, z, p1, p4, p2);
        AddTriangle(x, y, z, p1, p3, p4);
    }

    private void EmitVertexRamp(int x, int y, int z, Off3D off, Off3D ax, Off3D nax) {
        var rAx = ax.Opposite;
        var rNax = nax.Opposite;
        Vector3Int pos = new Vector3Int(x, y, z);
        Vector3 p1 = GetTempVertex(pos, off);
        ...
        AddTriangle(x, y, z, pp1, pp2, p6);
        AddTriangle(x, y, z, pp1, p6, p5);
        AddTriangle(x, y, z, p5, p6, pp3);
        AddTriangle(x, y, z, p6, pp4, pp3);
        ...
        if (!getNear(x, y, z, off + ax + nax) && !getNear(x, y, z, nax)) {
            if (getNear(x, y, z, ax + nax)) {
                if (!IsSubBlockMarked(x + off.x + nax.x, y + off.y + nax.y, z + off.z + nax.z, ax + rNax - off)) {
                    ...
                    AddTriangle(x, y, z, pp2, p0, p6);
                    AddTriangle(x, y, z, p6, p0, pp4);
                    AddTriangle(x, y, z, pp4, p0, p8);
                    AddTriangle(x, y, z, p8, p0, p7);
                    AddTriangle(x, y, z, p7, p0, p9);
                    AddTriangle(x, y, z, p9, p0, pp2);
                    MarkSubBlock(x + off.x + nax.x, y + off.y + nax.y, z + off.z + nax.z, ax + rNax - off);
                }
            } else {
                Vector3 p7 = GetTempVertex(pos, off + ax + nax);
                AddTriangle(x, y, z, pp2, p7, p6);
                if (roundP2) {
                    AddTriangle(x, y, z, p2, p7, pp2);
                }
                AddTriangle(x, y, z, p6, p7, pp4);
                if (roundP4) {
                    AddTriangle(x, y, z, pp4, p7, p4);
                }
            }
        }
    }
    ...
    private void EmitVertexTripleRamp(int x, int y, int z, Off3D off, Off3D ax, Off3D nax) {
        ...
        AddTriangle(x, y, z, p1, p0, p12);
        AddTriangle(x, y, z, p12, p0, p2);
        AddTriangle(x, y, z, p2, p0, p23);
        AddTriangle(x, y, z, p23, p0, p3);
        AddTriangle(x, y, z, p3, p0, p31);
        AddTriangle(x, y, z, p31, p0, p1);
    }
    ...
    private void EmitVertexDiagonal(int x, int y, int z, Off3D off, Off3D ax, Off3D nax) {
        ...
        AddTriangle(x, y, z, p1, p5, p6);
        AddTriangle(x, y, z, p1, p6, p2);
        AddTriangle(x, y, z, p1, p7, p5);
        AddTriangle(x, y, z, p1, p3, p7);
        AddTriangle(x, y, z, p5, p4, p6);
        AddTriangle(x, y, z, p5, p7, p4);
    }
